        ...
        <div className="myContent">
            <div className="movies spiderCard">
                <div className="content">
                    ...
                    <a href="https://www.imdb.com/title/tt0145487/" target="_blank" rel='noreferrer'>Learn More</a>
                </div>
            ...
            <div className="music spiderCard">
                ...
                <div className="content">
                    ...
                    <a href="https://open.spotify.com/album/35s58BRTGAEWztPo9WqCIs?si=fcLQN_AMTtyoqb147hlIRw&dl_branch=1" target="_blank" rel='noreferrer'>Learn More</a>
                </div>  
            </div>
            ...
            <div className="comics spiderCard">
                <div className="content">
                    ...
                    <a href="https://www.marvel.com/comics/discover/1130/start-here-spider-man" target="_blank" rel='noreferrer'>Learn More</a>
                </div>
